...
const navigationMenuTriggerStyle = cva(
    "group relative inline-flex h-9 w-max items-center justify-center " +
        "bg-transparent px-4 py-2 text-lg font-medium text-foreground " +
        "transition-colors focus:outline-none disabled:pointer-events-none disabled:opacity-50 " +
        /* underline */
        "after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-full " +
        "after:origin-center after:scale-x-0 after:bg-foreground " +
